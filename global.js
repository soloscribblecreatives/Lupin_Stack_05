var arrSurveyQuestions = {
   2: "What will you choose for him?"
};
...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="s1"><img src="slide1/s1.png" width="1024" height="768"/></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide1.css" media="screen"/><div class="s1"><img src="slide2/s1.png" width="1024" height="768"/></div><div class="option1"><img src="slide2/option1.png"></div><div class="option2"><img src="slide2/option2.png"></div><div class="s2"><img src="slide2/s2.png"></div><div class="s3"><img src="slide2/s3.png"></div><div class="s4"><img src="slide2/s4.png"/></div><div class="s5"><img src="slide2/s5.png"/></div><div class="s6"><img src="slide2/s6.png"/></div><div class="s7"><img src="slide2/s7.png"/></div><div class="s8"><img src="slide2/s8.png"/></div><div class="s9"><img src="slide2/s9.png"/></div><audio onended="myFunction()" autoplay><source src="slide2/voice2.mp3" type="audio/mp3"></audio>';
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide1.css" media="screen"/><div class="s1"><img src="slide3/s1.png" width="1024" height="768"/></div><div class="s2"><img src="slide3/s2.png"></div><audio autoplay><source src="slide3/voice3.mp3" type="audio/mp3"></audio>';
	break;
	case 4:
	content='<link rel="stylesheet" type="text/css" href="slide4/slide1.css" media="screen"/><div class="s1"><img src="slide4/s1.png" width="1024" height="768"/></div><div class="s2"><img src="slide4/s2.png"></div><audio autoplay><source src="slide4/voice4.mp3" type="audio/mp3"></audio>';
	break;
}
...
function open_page2(url,page_id,count){
	...
	if(page_id == 2){
		...
		<div id="slide01_question01_choices01" class="control-group">\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_01" name="checkB01" value="Lupivon(Vonoprazan)"/><div class="control_indicator" id="radio01" onclick="option1()"></div></label>\
			<label class="control control_radio"><div class="lbl_pos"></div><input type="radio" id="slide01_radio01_02" name="checkB01" value="PPI"/><div class="control_indicator" id="radio02" onclick="option2()"></div></label>\
		</div>\
