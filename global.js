...
function pop1() {
	$('.s1_2').addClass("s1_2_1");
	$('.s1_3').addClass("s1_3_1");
...
function pop2() {
	...
	$('.s1_4').addClass("s1_4_1");
	$('.s1_5').addClass("s1_5_1");
