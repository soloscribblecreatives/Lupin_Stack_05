...
switch(pg_id){
	...
	break;
	case 5:
	content='<link rel="stylesheet" type="text/css" href="slide5/slide5.css" media="screen"/><div class="background"><img src="slide5/1.jpg" width="1024" height="768" alt=""></div><div class="s5_1"><img src="slide5/2.jpg" width="1024" height="768" alt=""/></div><div class="s5_pop1" onclick="s5_pop1()"></div><div class="s5_c1ose1" onclick="s5_close1()"></div>';
	break;
	case 6:
	...
	break;
	case 9:
	content='<link rel="stylesheet" type="text/css" href="slide9/slide9.css" media="screen"/><div class="background"><img src="slide9/1.jpg" width="1024" height="768" alt=""></div><div class="s9_1"><img src="slide9/2.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop1" onclick="s9_pop1()"></div><div class="s9_2"><img src="slide9/3.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop2" onclick="s9_pop2()"></div><div class="s9_3"><img src="slide9/4.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop3" onclick="s9_pop3()"></div><div class="s9_4"><img src="slide9/5.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop4" onclick="s9_pop4()"></div><div class="s9_5"><img src="slide9/6.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop5" onclick="s9_pop5()"></div><div class="s9_6"><img src="slide9/7.jpg" width="1024" height="768" alt=""/></div><div class="s9_pop6" onclick="s9_pop6()"></div><div class="s9_c1ose1" onclick="s9_close1()"></div>';
	break;
	case 10:
...
function s9_pop2() {
	$('.s9_2').css("display","block");
	$('.s9_c1ose1').css("display","block");
	$('.s9_pop2').css("display","none");
}

function s9_pop3() {
	$('.s9_3').css("display","block");
	$('.s9_c1ose1').css("display","block");
	$('.s9_pop3').css("display","none");
}

function s9_pop4() {
	$('.s9_4').css("display","block");
	$('.s9_c1ose1').css("display","block");
	$('.s9_pop4').css("display","none");
}

function s9_pop5() {
	$('.s9_5').css("display","block");
	$('.s9_c1ose1').css("display","block");
	$('.s9_pop5').css("display","none");
}

function s9_pop6() {
	$('.s9_6').css("display","block");
	$('.s9_c1ose1').css("display","block");
	$('.s9_pop6').css("display","none");
}

function s9_close1() {
	$('.s9_1').css("display","none");
	$('.s9_2').css("display","none");
	$('.s9_3').css("display","none");
	$('.s9_4').css("display","none");
	$('.s9_5').css("display","none");
	$('.s9_6').css("display","none");
	$('.s9_c1ose1').css("display","none");
	$('.s9_pop1').css("display","block");
	$('.s9_pop2').css("display","block");
	$('.s9_pop3').css("display","block");
	$('.s9_pop4').css("display","block");
	$('.s9_pop5').css("display","block");
	$('.s9_pop6').css("display","block");
}